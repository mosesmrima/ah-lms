...
const CourseCard: React.FC<CourseCardProps> = ({ 
  ...
  return (
    <div 
      ...
      <Image
        src={image && image.trim() !== "" ? image : "/images/default-course.png"}
        alt={image && image.trim() !== "" ? title : `Default course image for ${title}`}
        fill
      ...
      <div className="absolute bottom-0 left-0 w-full pt-6 pb-3 px-3 bg-gradient-to-t from-red-700/90 to-[#1E1E1E]/80 flex flex-col justify-end">
        ...
        <div className="flex items-center justify-center mb-2">
          <Image src={authorAvatar && authorAvatar.trim() !== "" ? authorAvatar : "/images/default-avatar.png"} alt={authorAvatar && authorAvatar.trim() !== "" ? `Avatar for ${author}` : `Default avatar for ${author}`} width={24} height={24} className="rounded-full aspect-square object-cover w-6 h-6 mr-1.5" />
