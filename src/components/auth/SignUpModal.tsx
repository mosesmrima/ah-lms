...
const SignUpModal = ({ isOpen, onClose, onOpenLogin }: SignUpModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Sign up attempt with:', { email, fullName, password });
  };
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-black p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <button
                    type="button"
                    className="w-full flex items-center justify-center rounded-lg bg-white py-4 text-black font-medium hover:bg-gray-100 transition-colors"
                  >
                    <span className="mr-2">
                ...
                <div className="mt-6 text-center">
                  <div className="flex items-center justify-center">
                    <div className="flex-1 h-px bg-gray-600"></div>
                    <span className="px-4 text-sm text-gray-400">Don't have an account</span>
                    <div className="flex-1 h-px bg-gray-600"></div>
                  </div>
